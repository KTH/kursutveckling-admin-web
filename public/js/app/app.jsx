...
import { BrowserRouter, Switch, Route, matchPath } from 'inferno-router'
      ...
      <Provider routerStore={routerStore} >
        <ProgressLayer>
          <Switch>
            ...
            <Route path='/admin/kursutveckling/preview' component={AdminPreview} asyncBefore={AdminPreview.fetchData} />
