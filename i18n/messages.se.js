module.exports = {
  ...
  messages: {
    ...
    alert_graduation_rate_cant_be_calculated: 'Antal förstagångsregistrerade studenter och examinationsgrad kan inte räknas ut automatiskt för denna kursomgång.',
